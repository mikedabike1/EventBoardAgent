...
from src.gaming_events_scraper.discord_scraper import DiscordEventScraper, DISCORD_AVAILABLE
...
class TestDiscordEventScraper:
    ...
    async def test_scrape_server_events_no_discord(self):
        ...
        with patch('src.gaming_events_scraper.discord_scraper.DISCORD_AVAILABLE', False):
            scraper = DiscordEventScraper("token")
