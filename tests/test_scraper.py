...
class TestGamingEventsScraper:
    ...
    def test_scrape_all_sources_facebook_only(self, mock_print):
        ...
        self.scraper.facebook_scraper.scrape_page_events.assert_called_once_with("test_page")
    ...
    def test_scrape_all_sources_both_platforms(self):
        ...
        with patch('src.gaming_events_scraper.scraper.DISCORD_AVAILABLE', True), \
    ...
    def test_print_output_capture(self, mock_print):
        ...
        assert any("Found" in call and "events from Facebook page" in call for call in print_calls)